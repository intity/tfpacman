...
namespace TFlex.PackageManager.UI.Properties
{
    public class Resources
    {
        ...
        public static Dictionary<string, string[]> Strings => new Dictionary<string, string[]>
        {
            ...
            { "ui_0:ctl_5", GetString(MAIN_WINDOW, "menuItem5") },
            ...
            { "ui_0:c_4_3", GetString(MAIN_WINDOW, "menuItem4_3") },
            { "ui_0:c_5_1", GetString(MAIN_WINDOW, "menuItem5_1") },
            { "ui_0:c_6_1", GetString(MAIN_WINDOW, "menuItem6_1") },
            { "ui_0:c_6_2", GetString(MAIN_WINDOW, "menuItem6_2") },
            // AboutUs
