...
namespace UndoRedoFramework.Collections.Generic
{
    public class UndoRedoDictionary<TKey, TValue> : Dictionary<TKey, TValue>, IUndoRedoMember
    {
        ...
        /// </summary>
        /// <param name="capacity">
        /// The initial number of elements that the System.Collections.Generic.Dictionary<TKey,TValue> can contain.
        /// </param>
        ...
        /// </summary>
        /// <param name="dictionary">
        /// The System.Collections.Generic.IDictionary<TKey,TValue> whose elements are copied to 
        /// the new System.Collections.Generic.Dictionary<TKey,TValue>.
        /// </param>
        /// <param name="comparer">
